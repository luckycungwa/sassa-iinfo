...
export default function ContentEngine() {
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://srdgrantguide.co.za" },
    { "@type": "ListItem", "position": 2, "name": "${activeParsedDoc.meta.category || "Category"}", "item": "https://srdgrantguide.co.za/${activeParsedDoc.meta.category || ""}" },
    { "@type": "ListItem", "position": 3, "name": "${activeParsedDoc.meta.title || "Title"}", "item": "https://srdgrantguide.co.za${activeParsedDoc.meta.slug || ""}" }
  ]
}`}</pre>
                  </div>
                  {activeParsedDoc.meta.faqs?.length > 0 && (
