        ...
        <div className="bg-white border border-surface-dim rounded-3xl p-6 shadow-xs space-y-4 lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            ...
            <div className="p-4 bg-surface rounded-2xl space-y-2">
              ...
              <code className="block p-2 bg-white rounded-lg border border-surface-dim text-xs font-mono text-accent-dark">&lt;link rel=&quot;canonical&quot; href=&quot;https://sassaiinfo.co.za/status/pending&quot; /&gt;</code>
            </div>
            <div className="p-4 bg-surface rounded-2xl space-y-2">
