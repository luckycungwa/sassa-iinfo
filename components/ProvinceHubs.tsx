    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-8 bg-white border border-slate-100 rounded-2xl p-6 md:p-8 shadow-sm space-y-6">
        ...
        <div className="border-b border-slate-100 pb-5 space-y-2">
          ...
          <p className="text-slate-500 text-xs font-mono">Provincial Capital: {selectedProvince.capital}</p>
        </div>

        {/* Regional Office Info */}
        <div className="p-5 bg-slate-50 border border-slate-100 rounded-xl space-y-4">
          <h3 className="font-bold text-sm text-slate-800 flex items-center gap-1.5">
            <MapPin className="w-4.5 h-4.5 text-emerald-800" /> Provincial Head Office
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs md:text-sm text-slate-600">
            <div className="space-y-1">
              <p className="font-bold text-slate-400 uppercase font-mono text-[10px]">Physical Address</p>
              <p className="leading-relaxed font-semibold text-slate-700">{selectedProvince.regionalOfficeAddress}</p>
            </div>
            <div className="space-y-1">
              <p className="font-bold text-slate-400 uppercase font-mono text-[10px]">Phone Contact</p>
              <p className="leading-relaxed font-bold text-emerald-800 text-sm">{selectedProvince.regionalOfficePhone}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <h3 className="font-bold text-xs font-mono text-slate-400 tracking-wider uppercase">Local Collection Information</h3>
        ...
        {selectedProvince.faqs && selectedProvince.faqs.length > 0 && (
          <div className="space-y-3 pt-4 border-t border-slate-100">
            <h3 className="font-bold text-sm text-slate-800 flex items-center gap-1.5">
              <HelpCircle className="w-4 h-4 text-emerald-800" /> Provincial Frequently Asked Questions
            </h3>
