...
export const faqCategories: FAQCategory[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "Can I get a SASSA grant if I have a job?", answer: "Only if your income falls below the means test threshold. For most grants, single applicants must earn under R112,200 per year. For the SRD R370, monthly bank inflows must be under R624." },
      ...
      { question: "What is the means test for SASSA grants?", answer: "The means test is a financial assessment that checks your income and assets against legal thresholds. For single applicants, annual income must be below R112,200 and assets below R1,584,000. Married applicants have higher combined limits." },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "How much is the SASSA Child Support Grant in 2026?", answer: "The Child Support Grant is R580 per child per month. An additional top-up may apply for orphaned children living with relatives, but the exact amount changes over time and is subject to public debate, so confirm the current figure with SASSA." },
