...
export const metadata: Metadata = {
  title: "SASSA Payment Dates 2026 | Complete Social Grant Payout Schedule",
  description: "Complete SASSA payment calendar for 2026. View monthly payout dates for Older Person, Disability, Child Support, and SRD R370 grants. Current and future schedules with detailed notes.",
  alternates: { canonical: canonicalUrl("/payment-dates") },
  openGraph: {
    title: "SASSA Payment Dates 2026 | Complete Social Grant Payout Schedule",
    description: "Complete SASSA payment calendar for 2026 with monthly payout dates for all grant types.",
  },
};
...
export default function PaymentDatesPage() {
  ...
  const pageSchema = webpageSchema("SASSA Payment Dates 2026 | Complete Social Grant Payout Schedule", "Complete SASSA payment calendar for 2026 with monthly payout dates.", "/payment-dates");
