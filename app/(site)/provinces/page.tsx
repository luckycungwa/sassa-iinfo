...
export const metadata: Metadata = {
  ...
  description: "Province-specific SASSA information. Regional office addresses, collection points, and frequently asked questions for all 9 South African provinces.",
  alternates: { canonical: canonicalUrl("/provinces") },
  openGraph: {
    title: "SASSA Province Hubs | Regional Office & Collection Information",
    description: "Province-specific SASSA information for all 9 South African provinces.",
  },
};

export default function ProvincesHubPage() {
  const pageSchema = webpageSchema("SASSA Province Hubs | Regional Office & Collection Information", "Province-specific SASSA information for all 9 South African provinces.", "/provinces");
    ...
    <div>
      ...
      <section className="bg-yellow py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-bold text-carbon/50 uppercase tracking-widest mb-3">province hubs</p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-white/60">Use our office finder to locate your nearest branch</p>
            </div>
            <div className="flex gap-2">
              <Link href="/offices" className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-yellow text-carbon rounded-[22px] text-xs font-bold hover:opacity-90 transition">
