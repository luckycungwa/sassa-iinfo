...
export const metadata: Metadata = {
  title: "Lucky Cungwa — Editor, SASSA Grant Guide",
...
export default function AuthorPage() {
  const pageSchema = webpageSchema("Lucky Cungwa — Editor, SASSA Grant Guide", "Meet the editor behind the SASSA Grant Guide.", "/about/lucky-cungwa");
    ...
    <div>
      ...
      <section className="bg-yellow py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-bold text-carbon/50 uppercase tracking-widest mb-3">author</p>
      ...
      <section className="bg-paper py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="space-y-3 text-base text-carbon/70 leading-relaxed mt-6">
                ...
                <p>
                  ...
                  That independence is deliberate — it lets me tell you honestly what is confirmed, what may change,
          ...
          <div className="mt-14">
            ...
            <p className="text-base text-carbon/70 leading-relaxed max-w-2xl">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-white/60">Help keep this resource accurate</p>
            </div>
