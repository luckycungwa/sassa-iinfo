...
const faqs = [
  { question: "What is the income limit for SASSA grants?", answer: "For most grants, single applicants must earn below R96,240 per year. For the SRD R370 grant, your monthly bank inflows must stay under R624." },
